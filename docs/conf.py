# -*- coding: utf-8 -*-
#
# lqgbt-nse documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../lqgbt_oseen'))
...
htmlhelp_basename = 'lqgbt-nsedoc'
...
latex_documents = [
  ('index', 'lqgbt-nse.tex', u'lqgbt-nse Documentation',
...
man_pages = [
    ('index', 'lqgbt-nse', u'lqgbt-nse Documentation',
     [u'Jan Heiland'], 1)
]
...
texinfo_documents = [
  ('index', 'lqgbt-nse', u'lqgbt-nse Documentation',
   u'Jan Heiland', 'lqgbt-nse', 'One line description of project.',
   'Miscellaneous'),
]
